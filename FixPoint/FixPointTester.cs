...
│    \/___L\ \/__/\/_/\/____/\/__/\/_/\//\/_/ `/___/> \                    │
│      /\____/                                   /\___/                    │
│      \_/__/                                    \/__/                     │
│                                                                          │
│     Copyright (C) 2020-2021 Donney                                       │
│     Author: Donney <donney_luck@sina.cn>                                 │
│     Url:    https://github.com/donneyT/Math.git                          │
│     Desc:   this file is a part of math lib  Test the fixpoint           │
│                                                                          │
...
public class FixPointTests
{
    ...
    void Addition_Internal(float term1, float term2)
    {
        ...
        //Assert.Equal(fpresult, fpexpected);//���������Equal
